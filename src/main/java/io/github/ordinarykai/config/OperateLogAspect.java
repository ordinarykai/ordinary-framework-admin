...
import static io.github.ordinarykai.framework.common.result.ResultCode.FAILED;
...
public class OperateLogAspect {
    ...
    private Object around0(ProceedingJoinPoint joinPoint,
        ...
        // 目前只记录管理端的非GET请求日志
        HttpServletRequest request = io.github.ordinarykai.framework.common.util.ServletUtil.getRequest();
